...
articleDataModelFromJson(ArticleDataModel data, Map<String, dynamic> json) {
  ...
  if (json['datas'] != null) {
    data.datas = (json['datas'] as List)
        .map((v) => ArticleDataModelDatas().fromJson(v))
        .toList();
  }
  if (json['offset'] != null) {
...
articleDataModelDatasFromJson(
    ArticleDataModelDatas data, Map<String, dynamic> json) {
  ...
  if (json['tags'] != null) {
    data.tags = (json['tags'] as List)
        .map((v) => ArticleDataModelDatasTags().fromJson(v))
        .toList();
  }
  if (json['title'] != null) {
...
articleDataModelDatasTagsFromJson(
    ArticleDataModelDatasTags data, Map<String, dynamic> json) {
  if (json['name'] != null) {
...
Map<String, dynamic> articleDataModelDatasTagsToJson(
    ArticleDataModelDatasTags entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
