...
import 'package:flutter_wan_android_getx/generated/json/collect_link_model_helper.dart';
...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
		switch (type) {
			case CollectLinkModel:
				return collectLinkModelFromJson(data as CollectLinkModel, json) as T;
			case Language:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {
			case CollectLinkModel:
				return collectLinkModelToJson(data as CollectLinkModel);
			case Language:
  ...
  //Go back to a single instance by type
	static _fromJsonSingle<M>( json) {
		...
		if(type == (CollectLinkModel).toString()){
			return CollectLinkModel().fromJson(json);
		}
  ...
  //list is returned by type
	static M _getListChildType<M>(List data) {
		if(<CollectLinkModel>[] is M){
			return data.map<CollectLinkModel>((e) => CollectLinkModel().fromJson(e)).toList() as M;
		}
		if(<Language>[] is M){
